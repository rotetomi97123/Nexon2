...
const slider4 = ({ position4, setPosition4 }) => {
  ...
  const handleMouseUp = () => {
    if (isDragging) {
      ...
      const nearestSpot = spots.reduce((prev, curr) =>
        Math.abs(curr - position4) < Math.abs(prev - position4) ? curr : prev
      );
      setPosition4(nearestSpot);
    ...
    >
      ...
      {infoVisible && (
        <div className="infoDiv">
          ...
          <h2>SZENT ISVTÁN KIRÁLY ZENEI ALAPITVÁNY</h2>
          <p>
